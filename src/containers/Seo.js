...
const locales = {
  description:
    'Personal website of Aditya DS. Learn and level-up about React & JavaScript.',
};
...
export function Seo({
  ...
  const title = customTitle || 'Aditya DS';
        ...
        return (
          <>
            <Helmet>
              ...
              <meta name="twitter:creator" content="@ThisIsAdityads" />
